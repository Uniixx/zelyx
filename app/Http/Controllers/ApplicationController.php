...
class ApplicationController extends Controller
{
    ...
    public function emailApplication(){
        ...
        return view('pages.app-email', ['pageConfigs' => $pageConfigs, 'projects' => Project::where('user_id', Auth::user()->id)->get()]);
    }
    // chat App
    public function chatApplication(){
        $pageConfigs = ['isContentSidebar' => true, 'bodyCustomClass' => 'chat-application'];
        return view('pages.app-chat', ['pageConfigs' => $pageConfigs, 'projects' => Project::paginate(6)]);
    }
    // Todo App
