...
if (mix.inProduction()) {
  ...
  mix.webpackConfig({
    output: {
      publicPath: '/demo/frest-bootstrap-laravel-admin-dashboard-template-test/demo-1'
    }
  });
  mix.setResourceRoot("/demo/frest-bootstrap-laravel-admin-dashboard-template-test/demo-1");
}
mix.version();
