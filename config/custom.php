...
return [
  'custom' => [
    ...
    'pageHeader' => false, //options:Boolean: false(default), true (Page Header for Breadcrumbs) Warning:if pageheader true need to define a breadcrumbs in controller
    ...
    'templateTitle' => 'Zelyx', //template Title can be changed, default(Frest)
